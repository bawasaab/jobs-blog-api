        ...
        <div class="row">
            <div class="col-md-4">
                <div class="foot-widget pr-md-4 mb-md-0 mb-4">
                    ...
                    <p class="text-white">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla elementum viverra pharetra. Nulla
                        facilisis, sapien non pharetra venenatis, tortor erat tempus est, sed accumsan odio ante ac elit.
                        Nulla hendrerit a est vel ornare.
                    </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="foot-widget quick-links mb-md-0 mb-4">
                    ...
                    <ul>
                        <li><a href="javascript:void();"><i class="fas fa-arrow-right mr-1"></i> Home</a></li>
                        <li><a href="javascript:void();"><i class="fas fa-arrow-right mr-1"></i> All Jobs</a></li>
                        <li><a href="javascript:void();"><i class="fas fa-arrow-right mr-1"></i> About Us</a></li>
                        <li><a href="javascript:void();"><i class="fas fa-arrow-right mr-1"></i> Contact Us</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
